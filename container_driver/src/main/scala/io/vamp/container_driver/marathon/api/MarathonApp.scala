...
case class Docker(image: String, portMappings: List[DockerPortMapping], parameters: List[DockerParameter] = List(DockerParameter("privileged", "")), network: String = "BRIDGE")
